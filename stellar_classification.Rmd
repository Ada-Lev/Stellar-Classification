---
title: \Large STELLAR CLASSIFICATION BASED ON SPECTRAL CHARACTERISTICS
date: \begin{flushleft}Kristina Levina \thickspace \thickspace \thickspace \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \small`r format(Sys.time(), '%d/%m/%Y')`\end{flushleft}
output:
  pdf_document:
    fig_caption: yes        
    includes:  
      in_header: my_header.tex # This disables figure floating
    highlight: default
header-includes:
  ...
  - \usepackage{eulervm} # Change font for formulas
...
\definecolor{inline_code_color}{RGB}{220, 220, 220}
...
```{r fig1, echo=FALSE, fig.align='center', out.width="60%", fig.cap="\\label{fig:fig1}Distribution of stars, galaxies, and quasars in Stellar Classification Dataset - SDSS17 "}
